<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Administrator.master" AutoEventWireup="true" CodeBehind="CourseSelect.aspx.cs" Inherits="EduManSystem.Administrator.CourseSelect" %>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="Input_Add_Course_Select_ID">选课编号</label>
                                                    <asp:TextBox id="Input_Add_Course_Select_ID" runat="server"
                                                        name="course_select_id" class="form-control" type="text"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox id="Input_Add_Student_ID" runat="server"
                                                        name="course_select_name" class="form-control" type="text"
                                                        data-inputmask='"mask": "[a|9]{1,8}"' data-mask />
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="Input_Add_Course_Select_Score">成绩（默认请输入 0）</label>
                                                    <asp:TextBox id="Input_Add_Course_Select_Score" runat="server"
                                                        name="course_select_score" class="form-control" type="text"
                                                        data-inputmask='"mask": "9[9][9][9][.][9][9]"' data-mask />
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="Input_Add_Course_Select_Status">选课状态</label>
                                                    <asp:TextBox id="Input_Add_Course_Select_Status" runat="server"
                                                        name="course_select_status" class="form-control" type="text"
                                                        data-inputmask='"mask": "9[9]"' data-mask />
                                                </div>
                                            </div>
                                        </div>
                                        <asp:Button ID="Button_Add" runat="server" Text="添加选课信息"
                                ...
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="Input_Delete_Course_Select_ID">选课编号</label>
                                                    <asp:TextBox id="Input_Delete_Course_Select_ID" runat="server"
                                                        name="course_select_id" class="form-control" type="text"
                                                        data-inputmask='"mask": "[a|9]{1,8}"' data-mask />
                                                </div>
                                            </div>
                                        </div>
                                        <asp:Button ID="Button_Delete" runat="server" Text="删除选课信息"
                                ...
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="Input_Update_Course_Select_ID">选课编号</label>
                                                    <asp:TextBox id="Input_Update_Course_Select_ID" runat="server"
                                                        name="course_select_id" class="form-control" type="text"
                                                        data-inputmask='"mask": "[a|9]{1,8}"' data-mask />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox id="Input_Update_Value" runat="server" name="course_select_update_value"
                                                        class="form-control" type="text" />
                                                </div>
                                            </div>
                                        </div>
                                        <asp:Button ID="Button_Update" runat="server" Text="修改选课信息"
